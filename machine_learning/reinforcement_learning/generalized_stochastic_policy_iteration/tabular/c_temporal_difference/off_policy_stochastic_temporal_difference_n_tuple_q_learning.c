...
int main(int argc, char* argv[])
{
	...
	unsigned int number_of_state_action_value_functions = 8;
...
{
	unsigned int i;
	unsigned int next_action_index, max_action_count, not_updating_state_action_value_function_index = 0;
	...
	else
	{
		...
		{
			if (max_action_value < state_action_value_functions[updating_state_action_value_function_index][next_state_index][i])
			{
				max_action_value = state_action_value_functions[updating_state_action_value_function_index][next_state_index][i];
				state_action_value_function_max_tie_stack[next_state_index][0] = i;
				max_action_count = 1;
			}
			else if (max_action_value == state_action_value_functions[updating_state_action_value_function_index][next_state_index][i])
			{
