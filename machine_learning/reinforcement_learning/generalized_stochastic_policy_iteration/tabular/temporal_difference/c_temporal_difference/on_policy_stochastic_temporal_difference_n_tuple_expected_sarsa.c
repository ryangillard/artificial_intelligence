...
{
	unsigned int t, i;
	unsigned int action_index, successor_state_transition_index, next_state_index, updating_state_action_value_function_index;
	...
	for (t = 0; t < maximum_episode_length; t++)
	{
		...
		EpsilonGreedyPolicyFromStateActionFunction(number_of_actions_per_non_terminal_state, number_of_state_action_value_functions, state_action_value_functions, epsilon, state_index, policy, policy_cumulative_sum);
		...
		UpdateStateActionValueFunction(number_of_non_terminal_states, number_of_actions_per_non_terminal_state, policy, alpha, epsilon, discounting_factor_gamma, state_index, action_index, reward, next_state_index, updating_state_action_value_function_index, number_of_state_action_value_functions, state_action_value_functions);
...
{
	unsigned int i;
	unsigned int not_updating_state_action_value_function_index = 0;
	double not_updating_state_value_function_expected_value_on_policy;
	...
	else
	{
		...
		not_updating_state_value_function_expected_value_on_policy = 0.0;
		...
		{
			not_updating_state_value_function_expected_value_on_policy += policy[next_state_index][i] * state_action_value_functions[not_updating_state_action_value_function_index][next_state_index][i];
		} // end of i loop
		
		/* Calculate state-action-function expectation */
		state_action_value_functions[updating_state_action_value_function_index][state_index][action_index] += alpha * (reward + discounting_factor_gamma * not_updating_state_value_function_expected_value_on_policy - state_action_value_functions[updating_state_action_value_function_index][state_index][action_index]);
