	...
	for (t = 0; t < maximum_episode_length; t++)
	{
		...
		if (t < max_timestep)
		{
			...
			else
			{
				...
				GetTileIndices(number_of_state_tilings, number_of_state_tiles, state_double_variables[episode_log[t_plus_1_mod_n_plus_1].state_index], number_of_state_double_variables, state_int_variables[episode_log[t_plus_1_mod_n_plus_1].state_index], number_of_state_int_variables, next_state_tile_indices);
