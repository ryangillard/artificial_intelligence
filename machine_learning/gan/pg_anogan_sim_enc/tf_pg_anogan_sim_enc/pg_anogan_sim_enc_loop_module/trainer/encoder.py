...
#         logits_list = [
#             # 4x4
#             self.create_base_encoder_network(X=X, params=params),
#             # 8x8
#             self.create_growth_transition_encoder_network(
#                 X=X,
#                 alpha_var=alpha_var,
#                 params=params,
...
#             ),
#             # 1024x1024
#             self.create_final_encoder_network(X=X, params=params)
#         ]
...
#         return logits
    ...
    def get_train_eval_encoder_logits(self, X, alpha_var, params):
        ...
        Returns:
            Logits tensor of shape [batch_size, latent_size].
        """
